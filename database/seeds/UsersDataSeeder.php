    ...
    public function run()
    {
        ...
        */
        $adminUser1 = new User();
			...
			$adminUser1->phone		 = "051-1234567";
			$adminUser1->cell		 = "0365-7654321";
		...
		$adminUser2 = new User();
	        $adminUser2->first_name  = 'Developer';
    	    $adminUser2->last_name   = 'Admin';
        	$adminUser2->full_name   = 'Developer Admin';
	        $adminUser2->username    = 'atiq@teamwork.com.pk';
    	    $adminUser2->email       = 'atiq@teamwork.com.pk';
        	$adminUser2->password    = bcrypt('atiq');
			$adminUser2->address	 = "Near Fizan e Madina, Susan Road, Faisalabad";
			$adminUser2->phone		 = "041-1234567";
			$adminUser2->cell		 = "0393-1234567";
			$adminUser2->city_id	 = 1;
    	    $adminUser2->role_id     = '1';
        	$adminUser2->restaurant_id  = 0;
	        $adminUser2->created_by  = '1';
        $adminUser2->save();
